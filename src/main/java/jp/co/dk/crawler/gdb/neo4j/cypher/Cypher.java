...
public class Cypher implements Cloneable {
	 ...
	 * @throws CrawlerNeo4JCypherException Cypherオブジェクトのインスタンス生成に失敗した場合
	 */
	public Cypher(String cypher) throws CrawlerNeo4JCypherException {
		if (cypher == null || cypher.equals("")) throw new CrawlerNeo4JCypherException(CrawlerNeo4JMessage.CYPHER_IS_NOT_SET); 
	 ...
	 * @throws CrawlerNeo4JCypherException 引数に指定されたCypherがnullまたは空文字の場合
	 */
	public Cypher appendTop(String cypher) throws CrawlerNeo4JCypherException {
		if (cypher == null || cypher.equals("")) throw new CrawlerNeo4JCypherException(CrawlerNeo4JMessage.CYPHER_IS_NOT_SET);
	 ...
	 * @throws CrawlerNeo4JCypherException 引数に指定されたCypherがnullまたは空文字の場合
	 */
	public Cypher appendTop(Cypher cypher) throws CrawlerNeo4JCypherException {
		if (cypher == null || cypher.equals("")) throw new CrawlerNeo4JCypherException(CrawlerNeo4JMessage.CYPHER_IS_NOT_SET);
	 ...
	 * @throws CrawlerNeo4JCypherException 引数に指定されたCypherがnullまたは空文字の場合
	 */
	public Cypher append(String cypher) throws CrawlerNeo4JCypherException {
		if (cypher == null || cypher.equals("")) throw new CrawlerNeo4JCypherException(CrawlerNeo4JMessage.CYPHER_IS_NOT_SET); 
		this.cypher.append(cypher);
		return this;
	}
	 ...
	 * @throws CrawlerNeo4JCypherException 引数に指定されたCypherがnullまたは空文字の場合
	 */
	public Cypher append(Cypher cypher) throws CrawlerNeo4JCypherException {
