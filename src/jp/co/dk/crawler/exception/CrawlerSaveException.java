...
/**
 * CrawlerExceptionは、クローリングのデータ保存処理にて例外が発生したことを通知する例外クラスです。
 * 
 * @version 1.0
 * @author D.Kanno
 */
public class CrawlerSaveException extends AbstractMessageException{
	 ...
	 * @since 1.0
	 */
	public CrawlerSaveException(MessageInterface msg){
		super(msg);
	}
	 ...
	 * @since 1.0
	 */
	public CrawlerSaveException(MessageInterface msg, String str){
		super(msg, str);
	}
	 ...
	 * @since 1.0
	 */
	public CrawlerSaveException(MessageInterface msg, Throwable throwable){
		super(msg, throwable);
	}
