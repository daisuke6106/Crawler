...
//	 * @throws PageAccessException       アクティブになっているページのページデータの取得に失敗した場合
//	 * @throws DocumentException         アクティブになっているページのドキュメントオブジェクトの生成に失敗した場合
//	 * @throws PageMovableLimitException 
//	 * @throws PageRedirectException 
//	 * @throws PageIllegalArgumentException 
//	 */
//	public void saveImage() throws PageAccessException, DocumentException, PageIllegalArgumentException, PageRedirectException, PageMovableLimitException {
//		jp.co.dk.crawler.rdb.Page activePage = (jp.co.dk.crawler.rdb.Page)this.getPage();
