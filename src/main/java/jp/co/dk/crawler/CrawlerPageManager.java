 ...
 * @author D.Kanno
 */
public class CrawlerPageManager extends PageManager {
	 ...
	 */
	protected CrawlerPageManager(String url, PageRedirectHandler pageRedirectHandler) throws PageIllegalArgumentException, PageAccessException {
	 ...
	 * @throws PageAccessException ページにアクセスした際にサーバが存在しない、ヘッダが不正、データの取得に失敗した場合
	 */
	protected CrawlerPageManager(String url, PageRedirectHandler pageRedirectHandler, int maxNestLevel) throws PageIllegalArgumentException, PageAccessException {
	 ...
	 * @param maxNestLevel         ページ遷移上限数
	 */
	protected CrawlerPageManager(PageManager parentPage, Page page,  PageRedirectHandler pageRedirectHandler, int nestLevel, int maxNestLevel){
	...
	protected PageManager createPageManager(PageManager pageManager, Page page, PageRedirectHandler pageRedirectHandler, int nextLevel, int maxNestLevel) {
		return new CrawlerPageManager(pageManager, page, pageRedirectHandler, nextLevel, maxNestLevel);
	}
