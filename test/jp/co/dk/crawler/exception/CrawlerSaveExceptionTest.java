...
public class CrawlerSaveExceptionTest extends CrawlerFoundationTest {
	...
	public void constractor() {
		...
		CrawlerSaveException sut1 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		CrawlerSaveException sut2 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT, "test");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		CrawlerSaveException sut3 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		CrawlerSaveException sut4 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT, "test", new NullPointerException());
		...
		strList.add("test");
		CrawlerSaveException sut5 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT, strList, new NullPointerException());
		...
		CrawlerSaveException sut6 = new CrawlerSaveException(DETASTORETYPE_IS_NOT_SUPPORT, strArray, new NullPointerException());
