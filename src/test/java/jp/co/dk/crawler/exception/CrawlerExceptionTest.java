...
public class CrawlerExceptionTest extends CrawlerFoundationTest {
	...
	public void constractor() {
		...
		CrawlerException sut1 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		CrawlerException sut2 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT, "test");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		CrawlerException sut3 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		CrawlerException sut4 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT, "test", new NullPointerException());
		...
		strList.add("test");
		CrawlerException sut5 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT, strList, new NullPointerException());
		...
		CrawlerException sut6 = new CrawlerException(DETASTORETYPE_IS_NOT_SUPPORT, strArray, new NullPointerException());
