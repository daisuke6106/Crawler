...
public class CrawlerInitExceptionTest extends CrawlerFoundationTest {
	...
	public void constractor() {
		...
		CrawlerInitException sut1 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		CrawlerInitException sut2 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT, "test");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		CrawlerInitException sut3 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		CrawlerInitException sut4 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT, "test", new NullPointerException());
		...
		strList.add("test");
		CrawlerInitException sut5 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT, strList, new NullPointerException());
		...
		CrawlerInitException sut6 = new CrawlerInitException(DETASTORETYPE_IS_NOT_SUPPORT, strArray, new NullPointerException());
